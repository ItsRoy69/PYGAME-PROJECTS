...
def main(cfg):
    ...
    basic_label = Label(screen, cfg.SCREENSIZE[0] - 300, cfg.SCREENSIZE[1] - 80, 300, 100)
    basic_label.addtext('ROY', 60, cfg.FONTPATH['arfmoochikncheez'], (41, 41, 41))
    components.add(basic_label)
